...
export const LOCATIONS = {
  ...
  guilinNorthParking: loc('Parking Lot 1 de la estación Norte de Guilin', '桂林北站1号停车场', 'Parking Lot 1, Guilin North Railway Station, Diecai, Guilin'),
  jinkengVisitorCenter: loc('Jinkeng Dazhai Parking Visitor Center', '金坑大寨停车场游客中心', 'Jinkeng Dazhai Parking Visitor Center, Dazhai, Longsheng, Guilin'),
  yangshuoTouristParking: loc('Yangshuo Tourist Parking Lot, Bilian Lane', '阳朔旅游停车场（碧莲巷）', 'Yangshuo Tourist Parking Lot, Bilian Lane, Yangshuo, Guilin'),
...
export const DAYS = [
  ...
  { date:'2026-09-08', city:'Fenghuang → Longji', country:china, type:'Tren + bus', stay:'yunshang', warning:'Conexión de 47 minutos, must-confirm: D3967 llega a Guilin Norte a las 14:13 y el bus turístico sale a las 15:00. Ve directamente al Parking Lot 1, reserva/confirmar asientos y punto de salida en vivo; no está garantizado.', events:[event('07:09','⌁','Estar en estación de Fenghuang',LOCATIONS.fenghuangStation,'Llega una hora antes.','booked'),event('08:09–14:13','🚄','D3967 · coche 05 · asientos 2A / 2B',LOCATIONS.guilinNorth,'Fenghuang → Guilin Norte.','booked'),event('14:13','⚑','Ir directo al Parking Lot 1',LOCATIONS.guilinNorthParking,'桂林北站1号停车场. Reserva/confirmar asiento y punto de salida en vivo antes de llegar.','confirm'),event('15:00','🚌','Bus turístico Guilin Norte → Dazhai',LOCATIONS.jinkengVisitorCenter,'Destino: 金坑大寨停车场游客中心. 65 RMB por persona, ida (según el horario capturado); confirma la reserva.','confirm'),event('Tarde','⌂','Check-in en Jinkeng',STAYS[4].location,'Coordina recogida/traslado con el alojamiento.')] },
  { date:'2026-09-09', city:'Longji → Yangshuo', country:china, type:'Bus turístico', stay:'yangshuo', events:[event('Mañana','◌','Miradores compactos de las terrazas',LOCATIONS.longji,'Deja tiempo para volver al centro de visitantes.'),event('09:00','🚌','Bus directo Dazhai → Yangshuo',LOCATIONS.jinkengVisitorCenter,'Servicio directo temprano; 90 RMB por persona, ida, según captura. Confirma al reservar.','confirm'),event('13:30','🚌','Bus directo Dazhai → Yangshuo (recomendado)',LOCATIONS.jinkengVisitorCenter,'90 RMB por persona, ida, según captura; confirma al reservar. Prioridad tras una mañana compacta.','confirm'),event('14:30','🚌','Último directo Dazhai → Yangshuo',LOCATIONS.jinkengVisitorCenter,'Último servicio directo de respaldo; confirma plaza y salida.','confirm'),event('Llegada','⚑','Yangshuo Tourist Parking Lot, Bilian Lane',LOCATIONS.yangshuoTouristParking,'阳朔旅游停车场（碧莲巷）. Desde aquí, sigue al hotel.','confirm'),event('Alternativa','⚑','Dazhai → estaciones de Guilin',LOCATIONS.jinkengVisitorCenter,'Salidas de respaldo: 09:00, 10:30, 12:00, 13:30, 14:30 y 16:00. No es la ruta directa a Yangshuo.','confirm'),event('Noche','☷','West Street',loc('West Street','西街','West Street, Yangshuo, Guilin'),'Paseo y cena tranquila.')] },
...
export const RECOMMENDATIONS = [
  ...
  {city:'Shanghái',name:'Nanxiang historic xiaolongbao',local:'南翔馒头店',why:'Un clásico histórico y muy accesible para una parada turística en la zona de Yu Garden.',signature:'Xiaolongbao',price:'€',status:'suggested',day:'2026-09-12',source:'https://www.google.com/maps',location:loc('Nanxiang Steamed Bun Restaurant','南翔馒头店','85 Yuyuan Road, Huangpu, Shanghai')},
...
export const KIT = {
  ...
  phrases:[['这是酒店地址，请带我们去这里。','Esta es la dirección del hotel; llévenos aquí.'],['请带我们去这里','Llévenos aquí'],['不要辣 / 微辣','Sin picante / poco picante'],['我对___过敏','Soy alérgico/a a ___'],['多少钱？','¿Cuánto cuesta?'],['请问车站/检票口在哪里？','¿Dónde está la estación / puerta?'],['请帮帮我','Por favor, ayúdeme']],
  trainRoutes:[
