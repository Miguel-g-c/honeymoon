...
export const DAYS = [
  ...
  { date:'2026-09-03', city:'Pekín → Zhangjiajie', country:china, type:'Traslado', stay:'yurealm', events:[event('Mañana','☕','Mañana tranquila en Pekín',LOCATIONS.beijingWest,'Deja margen suficiente hacia PEK.'),event('19:15','✈','Vuelo PEK → Zhangjiajie',LOCATIONS.pek,'Llegada prevista 21:45.','booked'),event('21:45','⌂','Recogida y check-in',STAYS[1].location,'Recogida hotelera preacordada.','booked')] },
...
export const RECOMMENDATIONS = [
  {city:'Pekín',name:'1949 Duck de Chine',local:'1949 全鸭季',why:'La experiencia de pato pequinés pedida para una cena especial.',signature:'Pato de Pekín',price:'€€€',day:'2026-09-01',source:'https://guide.michelin.com/es/es/beijing-municipality/beijing/restaurante/1949-duck-de-chine',location:loc('1949 Duck de Chine','1949 全鸭季','23 Shunyi North Street, Chaoyang, Beijing')},
  {city:'Pekín',name:'The Red Chamber',local:'大红灯笼',why:'Alternativa Bib Gourmand de cocina norteña y pato.',signature:'Cocina del norte',price:'€€',day:'2026-09-01',source:'https://guide.michelin.com/',location:loc('The Red Chamber','大红灯笼','Beijing, China')},
  {city:'Pekín',name:'Liu Ma Ma Dumplings / Gong De Lin',local:'刘妈妈饺子 / 功德林',why:'Opción asequible para comer bien entre visitas.',signature:'Dumplings o cocina vegetariana',price:'€',day:'2026-08-31',source:'https://guide.michelin.com/',location:loc('Liu Ma Ma Dumplings','刘妈妈饺子','Beijing, China')},
  {city:'Zhangjiajie',name:'三下锅 cerca de Wulingyuan',local:'三下锅',why:'Especialidad local de olla compartida para una cena sencilla.',signature:'Sanxiaguo, cerdo ahumado o pescado agrio',price:'€',day:'2026-09-04',source:'https://www.amap.com/',location:loc('Restaurante 三下锅','三下锅','Wulingyuan, Zhangjiajie')},
  {city:'Furong',name:'Restaurante familiar del casco antiguo',local:'芙蓉镇本地菜',why:'Busca uno animado junto al sendero de la cascada, sin prometer un nombre no verificado.',signature:'米豆腐 (tofu de arroz)',price:'€',day:'2026-09-06',source:'https://www.amap.com/',location:LOCATIONS.furongWaterfall},
  {city:'Fenghuang',name:'Da Guo Da Zao Chai Huo Restaurant',local:'大锅大灶柴火饭店',why:'Opción asequible respaldada por Trip.com para probar cocina local.',signature:'血粑鸭, sopa de pescado agria',price:'€',day:'2026-09-07',source:'https://www.trip.com/',location:loc('Da Guo Da Zao Chai Huo Restaurant','大锅大灶柴火饭店','Fenghuang, Xiangxi')},
  {city:'Longji',name:'Cocina del homestay',local:'民宿厨房',why:'La opción más práctica tras el traslado y la más conectada con el lugar.',signature:'Arroz en bambú, té de aceite Yao, cerdo ahumado',price:'€',day:'2026-09-08',source:'https://www.trip.com/hotels/detail/?hotelId=109700425&checkIn=2026-09-08&checkOut=2026-09-09&locale=en-XX',location:STAYS[4].location},
  {city:'Yangshuo',name:'Liujie o Xie Dajie Beer Fish',local:'啤酒鱼',why:'Plato clásico del río Li para una cena de Yangshuo.',signature:'Pescado a la cerveza',price:'€€',day:'2026-09-10',source:'https://www.amap.com/',location:loc('Beer Fish, West Street','啤酒鱼','West Street, Yangshuo, Guilin'),note:'Confirma antes el peso y el precio del pescado.'},
  {city:'Shanghái',name:'Lao Di Fang Mian Guan',local:'老地方面馆',why:'Noodles Bib Gourmand para una comida sin ceremonia.',signature:'Noodles',price:'€',day:'2026-09-12',source:'https://guide.michelin.com/',location:loc('Lao Di Fang Mian Guan','老地方面馆','Shanghai, China')},
  {city:'Shanghái',name:'Da Hu Chun / Jia Jia Tang Bao',local:'大壶春 / 佳家汤包',why:'Dos clásicos rápidos para shengjian o xiaolongbao.',signature:'Shengjian y xiaolongbao',price:'€',day:'2026-09-13',source:'https://guide.michelin.com/',location:loc('Da Hu Chun','大壶春','Huangpu, Shanghai')},
  {city:'Gili Trawangan',name:'Jali Kitchen / Wilson’s',local:'Jali Kitchen',why:'Cena cómoda en el norte con alternativa práctica junto al hotel.',signature:'Cena relajada de isla',price:'€€',day:'2026-09-17',source:'https://www.google.com/maps',location:loc('Jali Kitchen','Jali Kitchen, Gili Trawangan','-8.3489, 116.0381',indonesia)},
  {city:'Gili Trawangan',name:'Casa Vintage Beach',local:'Casa Vintage Beach',why:'Una opción de playa para la puesta de sol.',signature:'Cóctel y cena al atardecer',price:'€€',day:'2026-09-18',source:'https://www.google.com/maps',location:loc('Casa Vintage Beach','Casa Vintage Beach, Gili Trawangan','-8.3549, 116.0336',indonesia)},
  {city:'Jimbaran',name:'Mercado de pescado + warung',local:'Pasar Ikan Kedonganan',why:'La manera más clara de buscar marisco con buena relación calidad-precio.',signature:'Pescado y marisco a la parrilla',price:'€€',day:'2026-09-20',source:'https://www.google.com/maps',location:loc('Kedonganan Fish Market','Pasar Ikan Kedonganan','-8.7552, 115.1742',indonesia),note:'Acordad peso y precio antes de cocinar.'},
];
